...
### Usage
NOTE! database.rb has to be alone in the db dir, because <code>Dir["**/*"].length</code> was used few times!! The only files which can be there are sessions.txt files!
